...
pub use kani_intrinsics::IntrinsicGeneratorPass;
pub use loop_contracts::LoopContractPass;
pub use rustc_intrinsics::RustcIntrinsicsPass;
mod stubs;
...
impl BodyTransformation {
    pub fn new(queries: &QueryDb, tcx: TyCtxt, unit: &CodegenUnit) -> Self {
        ...
        transformer.add_pass(
            queries,
            IntrinsicGeneratorPass::new(unsupported_check_type, queries),
        );
        ...
        &self
            ...
            .or_insert_with(|| {
                ...
                for pass in self
                    .stub_passes
                    .iter_mut()
                    .chain(self.inst_passes.iter_mut())
                {
...
impl GlobalPasses {
    pub fn new(queries: &QueryDb, tcx: TyCtxt) -> Self {
        let mut global_passes = GlobalPasses {
            global_passes: vec![],
        };
