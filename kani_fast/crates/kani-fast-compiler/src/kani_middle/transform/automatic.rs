...
impl TransformPass for AutomaticArbitraryPass {
    ...
    {
        matches!(
            query_db.args().reachability_analysis,
...
impl AutomaticArbitraryPass {
    ...
    fn call_kani_any_for_variant(
        ...
        let mut assign_instr = SourceInstruction::Terminator {
            bb: source.bb() - 1,
        };
    ...
    fn generate_enum_body(&self, def: AdtDef, args: GenericArgs, body: Body) -> Body {
        ...
        let switch_int_instr = SourceInstruction::Terminator {
            bb: source.bb() - 1,
        };
...
impl TransformPass for AutomaticHarnessPass {
    ...
    fn transform(&mut self, tcx: TyCtxt, body: Body, instance: Instance) -> (bool, Body) {
        ...
        harness_body.insert_call(
            ...
            arg_locals
                .iter()
                .map(|lcl| Operand::Copy(Place::from(*lcl)))
                .collect::<Vec<_>>(),
            ret_place,
        );
