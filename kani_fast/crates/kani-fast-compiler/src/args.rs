...
#[derive(
    Debug, Default, Display, Clone, Copy, AsRefStr, EnumString, VariantNames, PartialEq, Eq,
)]
#[strum(serialize_all = "snake_case")]
pub enum BackendOption {
    /// CHC (Constrained Horn Clauses) backend - Kani Fast default
    #[strum(serialize = "chc")]
    #[default]
    Chc,
...
pub struct Arguments {
    ...
    #[clap(long = "backend", default_value_t = BackendOption::Chc)]
