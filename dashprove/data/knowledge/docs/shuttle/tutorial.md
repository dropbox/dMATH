...
[[crates.io]][1] [[docs.rs]][2] [[Tests]][3]

Shuttle is a library for testing concurrent Rust code. It is an implementation of a number of
*randomized concurrency testing* techniques, including [A Randomized Scheduler with Probabilistic
Guarantees of Finding Bugs][4].
...
A Shuttle version of the above test just wraps the test body in a call to Shuttle's `check_random`
function, and replaces the concurrency-related imports from `std` with imports from `shuttle`:
...
Shuttle is inspired by the [Loom][5] library for testing concurrent Rust code. Shuttle focuses on
randomized testing, rather than the exhaustive testing that Loom offers. This is a
soundness—scalability trade-off: Shuttle is not sound (a passing Shuttle test does not prove the
...
See [CONTRIBUTING][6] for more information.

[1]: https://crates.io/crates/shuttle
[2]: https://docs.rs/shuttle
[3]: https://github.com/awslabs/shuttle/actions/workflows/tests.yml
[4]: https://www.microsoft.com/en-us/research/wp-content/uploads/2016/02/asplos277-pct.pdf
[5]: https://github.com/tokio-rs/loom
[6]: /awslabs/shuttle/blob/main/CONTRIBUTING.md#security-issue-notifications
