//! Model path extraction for ERAN
//!
//! Extracts ONNX/PB model paths from USL specifications.

use dashprove_usl::ast::{Expr, Property};
use dashprove_usl::typecheck::TypedSpec;

/// Extract ONNX/PB model path from USL specification
///
...
pub fn find_model_path_in_expr(expr: &Expr) -> Option<String> {
    match expr {
        Expr::String(s) => {
